...
@Entity
@Table(name = "MANUFACTURER_AREA_MANAGER")
@AttributeOverrides({
...
public class ManufacturerAreaManager extends BusinessEntity{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ManufacturerAreaManager other = (ManufacturerAreaManager) obj;
		if (ID != other.ID)
			return false;
		if (code == null) {
			if (other.code != null)
	...
	public String toString() {
		return "ManufacturerAreaManager [ID=" + ID + ", code=" + code + ", name=" + name + ", effectiveFrom="
