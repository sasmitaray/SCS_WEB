...
<head>
	<title>Edit Manufacturer Delivery Executive Mapping</title>
	<!-- Bootstrap Core CSS -->
	<meta charset="utf-8">
		...
		<div class="row top-height">
			<div class="col-md-8 ">
				<form:form modelAttribute="manufacturer" method="post"
					action="${contextPath}/web/manufacturerWeb/updateAassignedDelivexecs">
					<fieldset>
						<legend>Manufacturer to Delivery Executive Mapping</legend>
						<div class="form-group">
							...
							<div class="form-group">
								...
								<form:select path="delivExecsIDs" cssClass="form-control" multiple="true">
