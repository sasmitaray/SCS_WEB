					...
					<c:choose>
    					...
    					<c:otherwise>
        					<div class="alert alert-success">
	 						 <strong>Success!</strong><br> Sales Executive Visit for customer/s has been cancelled successfully.
						</div>
    					</c:otherwise>
					</c:choose>
					<div class="form_submit">
						<a href="<%=request.getContextPath()%>/web/orderWeb/scheduledOrderBookings" class="btn btn-primary">Back To Scheduled Orders</a>
					</div>
			</div>
		</div>
	</div>
