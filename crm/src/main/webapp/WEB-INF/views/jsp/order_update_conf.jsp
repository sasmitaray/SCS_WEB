		...
		<div class="row top-height">
			<div class="col-md-8 ">
					...
					<div class="form_submit">
						<a href="<%=request.getContextPath()%>/web/orderWeb/${orderID}" class="btn btn-primary">View Order Detail</a>
						<a href="<%=request.getContextPath()%>/web/orderWeb/list" class="btn btn-primary">View List Of Orders</a>
					</div>
			</div>
		</div>
	</div>
