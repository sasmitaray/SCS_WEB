					...
					<c:choose>
    					...
    					<c:otherwise>
        					<div class="alert alert-success">
	 						 <strong>Success!</strong><br> Beat has been successfully removed.
						</div>
    					</c:otherwise>
					</c:choose>
					<div class="form_submit">
						<a href="<%=request.getContextPath()%>/web/beatWeb/list" class="btn btn-primary">View List Of Beats</a>
						<a href="<%=request.getContextPath()%>/web/beatWeb/createBeatForm" class="btn btn-primary">Create Another Beat</a>
					</div>
			</div>
		</div>
	</div>
