					...
					<c:choose>
    					...
    					<c:otherwise>
        					<div class="alert alert-success">
	 						 <strong>Success!</strong><br> Customer has been successfully created.
						</div>
    					</c:otherwise>
					</c:choose>
					<div class="form_submit">
						<a href="<%=request.getContextPath()%>/web/customerWeb/list" class="btn btn-primary">View List Of Customers</a>
						<a href="<%=request.getContextPath()%>/web/customerWeb/createCustomerForm" class="btn btn-primary">Add a New Customer</a>
					</div>
			</div>
		</div>
	</div>
