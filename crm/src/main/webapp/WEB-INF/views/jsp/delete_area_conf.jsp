					...
					<c:choose>
    					...
    					<c:otherwise>
        					<div class="alert alert-success">
	 						 <strong>Success!</strong><br> Area has been successfully removed.
						</div>
    					</c:otherwise>
					</c:choose>
					<div class="form_submit">
						<a href="<%=request.getContextPath()%>/web/areaWeb/list" class="btn btn-primary">View List Of Areas</a>
						<a href="<%=request.getContextPath()%>/web/areaWeb/createAreaForm" class="btn btn-primary">Create Another Area</a>
					</div>
			</div>
		</div>
	</div>
